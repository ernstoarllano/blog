    ...
    <section class="space-y-8">
        ...
        <div class="space-y-2">
            ...
            <p>
                ...
                patterns that turned multi-day tasks into hours. When something
                I build removes friction for multiple developers, that's the
                multiplier effect I'm after.
            </p>
        </div>
        <div class="space-y-2">
            ...
            <p>
                ...
                learned that being forward-thinking means knowing when to push
                for better tools and when to stick with what works.
            </p>
        </div>
        <div class="space-y-2">
            <h3>
            ...
            <p>
                ...
                solid engineering aren't separate concerns. Thoughtful design
                and clean code compound into products people actually enjoy
                using.
            </p>
        </div>
        <div class="space-y-2">
            ...
            <p>
                ...
                with product and design. I give thoughtful PR reviews, help
                teammates debug tricky issues, and try to make showing up to
                work a little more enjoyable.
            </p>
        </div>
    </section>
    <section class="space-y-8">
        ...
        <div class="space-y-2">
            ...
            <p>
                ...
                systems faster. I also lean on diagrams when visual models make
                things clearer.
            </p>
        </div>
        <div class="space-y-2">
            ...
            <p>
                ...
                position. I hope you'll do the same with me.
            </p>
        </div>
        <div class="space-y-2">
            ...
            <p>
                ...
                supportive and approachable is part of what makes engineering
                work actually work.
            </p>
        </div>
        <div class="space-y-2">
