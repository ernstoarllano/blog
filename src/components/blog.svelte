<section class="max-w-[500px] mx-auto pb-16">
    <div class="space-y-8">
        <h2 class="text-md font-semibold">Blog</h2>
        <div>
            <ul class="space-y-4">
                <li class="flex justify-between">
                    <a class="text-sm text-zinc-300" href="#">Shipping Features, Expecting a Baby, Then… This</a>
                ...
                <li class="flex justify-between">
                    ...
                    <time class="text-xs text-zinc-400" datetime="2025-11-01">Nov 1, 25</time>
                </li>
                <li class="flex justify-between">
